...
import com.mamrez.sample.service.GroupService;
...
public class GroupResourceIT {
    ...
    public void createGroup() throws Exception {
        ...
        assertThat(testGroup.getDetails()).isEqualTo(DEFAULT_DETAILS);
    }
    ...
    public void updateGroup() throws Exception {
        ...
        assertThat(testGroup.getDetails()).isEqualTo(UPDATED_DETAILS);
    }
